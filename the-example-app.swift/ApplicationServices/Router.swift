...
final class Router {
    ...
    init(services: ApplicationServices, deepLinkRouter: DPLDeepLinkRouter) {
    ...
    func updateStatesInServices(contentful: StatefulContentfulClientProvider, from deepLink: DPLDeepLink) {
        ...
        let state = StatefulContentfulClientProvider.State(api: apiState(from: deepLink),
    ...
    func apiState(from deepLink: DPLDeepLink) -> StatefulContentfulClientProvider.State.API {
    ...
    func localeState(from deepLink: DPLDeepLink, newService: StatefulContentfulClientProvider) -> Contentful.Locale {
